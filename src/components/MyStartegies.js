      ...
      {filteredData.map((strategy) => (
        <div className="row col-10 nays center-div" key={strategy.id}>
          <div className="row">
            ...
            <div
              className="btn col-2 btn-danger nays"
              onClick={() => removeMyStrategies(strategy.id)}
            >
              Unsubscribe
            </div>
          </div>
          <div className="row nays">
            <div className="col-12">{strategy.content}</div>
          </div>
          <div className="row">
            ...
            <div className="col-12 m-3 d-flex justify-content-end">
              <button
                ...
                data-toggle="modal"
                data-target={`#exampleModalCenter${strategy.id}`}
              >
                Apply
              </button>
              ...
              <div
                ...
                id={`exampleModalCenter${strategy.id}`}
                tabIndex="-1"
                role="dialog"
                aria-labelledby={`exampleModalCenterTitle${strategy.id}`}
                aria-hidden="true"
              >
                <div
                  ...
                  <div className="modal-content tyhgcv">
                    ...
                    <div className="modal-footer">
                      ...
                      <button
                        type="button"
                        className="btn btn-primary"
                        onClick={() => addDeployed(strategy.id)}
                      >
                        Save changes
                      </button>
                    </div>
