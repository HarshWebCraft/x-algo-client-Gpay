...
function New_Signup() {
    ...
    return (
        <div className="signup-container">
            <div className={`signup-box ${aniLoading ? 'animate__animated animate__fadeIn' : ''}`}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button className={loading?'signup-button pt-2 pb-2':'signup-button'}  style={{fontWeight:600}} type="submit">
            ...
            <div className={`lottie-animation ${aniLoading ? 'animate__animated animate__fadeIn' : ''}`}>
                <Lottie
