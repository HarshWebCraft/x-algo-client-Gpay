    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const response = await axios.get('/data.xlsx', { responseType: 'arraybuffer' });
        ...
        <div className="container">
            ...
            <div className={`${localStorage.getItem('theme')=="light-theme"?"row jahgs":"jhsbdchjbdcbs"}`}>
                ...
                <div className='col-12'>
                    ...
                    <table className={`${localStorage.getItem('theme')=="light-theme"?"col-12 kjhuk":"hasbchjbasbhjabjh"}`}>
                        <tbody>
                            <tr className='adsdas'>
