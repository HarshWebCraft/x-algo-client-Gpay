...
const PrivacyPolicy = () => {
    return (
        <div id="i89pol" className="gjs-ft-row ajkscjskacamcjksdcnfjkn">
            <div id="ibtd05" className="gjs-ft-column gjs-ft-col-md akhsbaghbchjsbcghbsdghb">
                ...
                <p id="isak" className="ftparagraph">
                    ...
                    and/or becomes subject to a different Privacy Policy.
                    <br />
                    <br />
                    Security
                    <br />
                    ...
                    Information, to India and process it there.
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    This Privacy Policy is effective as of November 01, 2018 and will
