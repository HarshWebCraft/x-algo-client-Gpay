...
function Profile() {
    ...
    return (
        <div className={localStorage.getItem('theme') == "light-theme" ? "container" : "jhvchdfesubgbewhgd container"}>
            <Navbar />
            <div className={localStorage.getItem('theme')=="light-theme" ? "abnc" : "hjvsgcvajsbcnascasc"}>
                ...
                <div className='ksljd'>
                            ...
                            <tbody>
                                {clientdata.map((item, index) => (
                                    <tr key={index}>
                                        ...
                                        <td style={{ maxWidth: '100%', overflow: 'hidden', whiteSpace: 'nowrap', textOverflow: 'ellipsis' }}>{(item.userData.data.name).toUpperCase()}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
                    ...
                    >
                                    ...
                                    <div style={iconStyle2} className='sdnjksdnvbshdvbhjsbhdv'>
                                        <div>
                                            <label htmlFor="ajsd">
                                                <div>
                                                    {newImg ? (
                                                        <img src={newImg} alt="Profile" className='profilePic2'/>
                                                    ) : (
                        ...
                        <Modal.Footer className={localStorage.getItem('theme')=="light-theme" ? "" : "kbdsfgvbfnhavfyydcdfnm"}>
                            <Button variant="primary" onClick={handleSave}>Edit</Button>
                        </Modal.Footer>
                    </Modal>
                </div>
            </div>
